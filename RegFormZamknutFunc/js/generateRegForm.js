(function() {
    App.generateRegForm =
        function generateRegForm() {
            ...
            form.addDivOkToForm('success');
            form.addButton('Register', "register", App.registrationAjax);
            form.addRowFooter();
            form.addDivFooter();
            form.addFormToPage(".rowBody");                                                                     //добавление формы на страницу, т.е. закидывается по классу который прописан в register.php
        }
})();