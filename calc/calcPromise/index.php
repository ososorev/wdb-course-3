...
<script>
	function send(event){
		...
		fetch("scripts/math.php",{method:"post", body:new FormData(document.forms[0])}).then(response=>response.text()).then(text=>{document.getElementById("result").innerHTML=text;})
	}
</script>
</head>
