...
function connectToDB() {
    ...
    mysqli_select_db("$dbname", $link) || die("Couldn't open db: $dbname. Error if any was: ".mysqli_error() );
}
    ...
    $result=mysqli_query($query, $link) or die("Died inserting login info into db.  Error returned if any: ".mysqli_error());
